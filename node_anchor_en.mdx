...
- **Entry Conditions**: Requires staking a certain amount of USDO.
...
- **Evaluation Criteria**:
  ...
  - Total OCT/USDO acquisition: 5 million USDO added per month.
...
- **Node Incentives**:
  ...
  - **Periodic Rewards**: Nodes receive additional ecosystem rewards (primarily in OCT and USDO) based on their staking ratio and contribution, further incentivizing validators to actively participate in ecosystem co-building.
...
- **Evaluation Criteria**:
  - Total user acquisition (unique phone numbers or emails): 10,000 new users per month.
  - Total OCT/USDO acquisition: 1 million USDO added per month.
  ...
  - Community contribution: Contributions from acquired users to the platform, such as suggestions, issue reporting, and governance participation.
- **Node Incentives**:
  - **Periodic Rewards**: Nodes receive additional ecosystem rewards (primarily in OCT and USDO) based on their application contributions, further incentivizing developers to actively participate in ecosystem co-building.
...
- **Evaluation Criteria**:
  ...
  - Total OCT/USDO acquisition: 1 million USDO added.
  - Transaction frequency: Over 1,000 transactions per day.
  - **Node Incentives**: Nodes receive additional ecosystem rewards (primarily in OCT and USDO) based on their asset contributions, further incentivizing asset holders to actively participate in ecosystem co-building.
...
- To encourage active contributions to the ecosystem, OneChain will supplement a certain proportion of the USDO reward pool, distributing rewards based on the comprehensive contribution score C[i] of each node.
...
- **Contribution Reward Formula**:
  ...
  - T_USDO: USDO reward pool for the current cycle.
